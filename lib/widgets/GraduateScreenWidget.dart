...
class GraduateScreen extends StatefulWidget {
  const GraduateScreen({super.key});

  @override
  State<GraduateScreen> createState() => _GraduateScreenState();
}

class _GraduateScreenState extends State<GraduateScreen> {
