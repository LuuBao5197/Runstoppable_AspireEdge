  ...
  Widget build(BuildContext context) {
    if (user == null) {
      return Scaffold(
        ...
        body: const Center(child: Text("Please log in to view your videos")),
      );
    }
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: firestore
            .collection("videos")
            .where("createdBy", isEqualTo: user!.uid) // chỉ lấy video của user
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    EditVideoScreen(videoId: docs[index].id),
                              ),
                            );
                          },
                        ),
                            ...
                            IconButton(
                              ...
                              onPressed: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (_) =>
                                        EditVideoScreen(videoId: doc.id),
                                  ),
                                );
                              },
                            ),
